\documentclass[10 pt , a 4 paper ]{article}
...
%	\newpage
  ...
  \section*{Task 1 - Edge-Based Segmentation}
  \section*{Task 2 – Region-Based Segmentation}

  \section*{Task 3 – Clustering-Based Segmentation}
